...
import org.tcai.R;
import org.tcai.providers.SslExceptionsWrapper;
...
public class CustomWebViewClient extends WebViewClient {
	...
	public void onReceivedSslError(final WebView view,
		...
		String authority = view.getResources().getString(
				R.string.UnknownAutority);
		...
		if (hasAuthority) {
			int result = SslExceptionsWrapper.getStatusForAuthority(view
			...
			case SslExceptionsWrapper.AUTHORITY_ALLOWED:
				...
				Toast.makeText(
						...
						String.format(
								...
								authority), Toast.LENGTH_SHORT).show();
				break;
		...
		if (askUser) {
			...
			sb.append(String.format(
					view.getResources().getString(R.string.SslWarningsHeader),
					authority));
			sb.append("\n\n");

			sb.append(Html.fromHtml(SslExceptionsWrapper
					.sslErrorReasonToString(view.getContext(), errorCode)));
			...
			View checkBoxLayout = adbInflater.inflate(R.layout.checkbox_layout,
					null);
			final CheckBox rememberCheckBox = (CheckBox) checkBoxLayout
					.findViewById(R.id.RemenberChoiceCheckBox);

			builder.setView(checkBoxLayout);

			builder.setInverseBackgroundForced(true);
			builder.setPositiveButton(
					view.getResources().getString(R.string.Continue),
					new DialogInterface.OnClickListener() {

						@Override
						public void onClick(DialogInterface dialog, int which) {
							if (rememberCheckBox.isChecked()) {
								SslExceptionsWrapper.setSslException(view
										.getContext().getContentResolver(),
										finalAuthority, errorCode, true);
							}
			...
			builder.setNegativeButton(
					view.getResources().getString(R.string.Cancel),
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							if (rememberCheckBox.isChecked()) {
								SslExceptionsWrapper.setSslException(view
										.getContext().getContentResolver(),
										finalAuthority, errorCode, false);
							}
	...
	public void onReceivedHttpAuthRequest(WebView view,
		...
		if (username != null && password != null) {
			...
			LayoutInflater factory = LayoutInflater.from(mUIManager
					.getMainActivity());
					...
					.setTitle(
							String.format(
									mUIManager
											.getMainActivity()
											.getString(
													R.string.HttpAuthenticationDialogDialogTitle),
									host, realm))
							...
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									String pw = ((EditText) v
											...
											.getText().toString();
									mUIManager.setHttpAuthUsernamePassword(
											host, realm, nm, pw);
	...
	public void onFormResubmission(WebView view, Message dontResend,
		...
		new AlertDialog.Builder(mUIManager.getMainActivity())
				.setTitle(R.string.FormResubmitTitle)
	...
	private boolean checkUrlLoading(String url) {
		...
		try {
			...
			Log.w("CustomWebViewClient",
					"Bad URI " + url + ": " + e.getMessage());
			return false;
		}

		if (mUIManager.getMainActivity().getPackageManager()
