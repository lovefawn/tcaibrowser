...
import org.tcai.utils.UrlUtils;
...
public class CustomWebView extends WebView implements DownloadListener {
	...
	private Intent createIntent(String action, int actionId, int hitTestResult, String url) {
		Intent result = new Intent(getContext(), TcaiBrowserActivity.class);
		...
		setOnCreateContextMenuListener(new OnCreateContextMenuListener() {
			...
			public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
				...
				if ((resultType == HitTestResult.ANCHOR_TYPE) ||
					...
					MenuItem item = menu.add(0, TcaiBrowserActivity.CONTEXT_MENU_OPEN, 0, R.string.ContextMenuOpen);
					item.setIntent(createIntent(Constants.ACTION_BROWSER_CONTEXT_MENU, TcaiBrowserActivity.CONTEXT_MENU_OPEN, resultType, result.getExtra()));
	
					item = menu.add(0, TcaiBrowserActivity.CONTEXT_MENU_OPEN_IN_NEW_TAB, 0, R.string.ContextMenuOpenNewTab);					
					item.setIntent(createIntent(Constants.ACTION_BROWSER_CONTEXT_MENU, TcaiBrowserActivity.CONTEXT_MENU_OPEN_IN_NEW_TAB, resultType, result.getExtra()));
					
					item = menu.add(0, TcaiBrowserActivity.CONTEXT_MENU_OPEN_IN_BACKGROUND, 0, R.string.ContextMenuOpenInBackground);					
					item.setIntent(createIntent(Constants.ACTION_BROWSER_CONTEXT_MENU, TcaiBrowserActivity.CONTEXT_MENU_OPEN_IN_BACKGROUND, resultType, result.getExtra()));
					
					item = menu.add(0, TcaiBrowserActivity.CONTEXT_MENU_COPY, 0, R.string.ContextMenuCopyLinkUrl);					
					item.setIntent(createIntent(Constants.ACTION_BROWSER_CONTEXT_MENU, TcaiBrowserActivity.CONTEXT_MENU_COPY, resultType, result.getExtra()));
					
					item = menu.add(0, TcaiBrowserActivity.CONTEXT_MENU_DOWNLOAD, 0, R.string.ContextMenuDownload);					
					item.setIntent(createIntent(Constants.ACTION_BROWSER_CONTEXT_MENU, TcaiBrowserActivity.CONTEXT_MENU_DOWNLOAD, resultType, result.getExtra()));
					
					item = menu.add(0, TcaiBrowserActivity.CONTEXT_MENU_SHARE, 0, R.string.ContextMenuShareLinkUrl);					
					item.setIntent(createIntent(Constants.ACTION_BROWSER_CONTEXT_MENU, TcaiBrowserActivity.CONTEXT_MENU_SHARE, resultType, result.getExtra()));
					...
					MenuItem item = menu.add(0, TcaiBrowserActivity.CONTEXT_MENU_OPEN, 0, R.string.ContextMenuViewImage);					
					item.setIntent(createIntent(Constants.ACTION_BROWSER_CONTEXT_MENU, TcaiBrowserActivity.CONTEXT_MENU_OPEN, resultType, result.getExtra()));
					
					item = menu.add(0, TcaiBrowserActivity.CONTEXT_MENU_COPY, 0, R.string.ContextMenuCopyImageUrl);					
					item.setIntent(createIntent(Constants.ACTION_BROWSER_CONTEXT_MENU, TcaiBrowserActivity.CONTEXT_MENU_COPY, resultType, result.getExtra()));
					
					item = menu.add(0, TcaiBrowserActivity.CONTEXT_MENU_DOWNLOAD, 0, R.string.ContextMenuDownloadImage);					
					item.setIntent(createIntent(Constants.ACTION_BROWSER_CONTEXT_MENU, TcaiBrowserActivity.CONTEXT_MENU_DOWNLOAD, resultType, result.getExtra()));	
					
					item = menu.add(0, TcaiBrowserActivity.CONTEXT_MENU_SHARE, 0, R.string.ContextMenuShareImageUrl);					
					item.setIntent(createIntent(Constants.ACTION_BROWSER_CONTEXT_MENU, TcaiBrowserActivity.CONTEXT_MENU_SHARE, resultType, result.getExtra()));
					...
					MenuItem item = menu.add(0, TcaiBrowserActivity.CONTEXT_MENU_SEND_MAIL, 0, R.string.ContextMenuSendEmail);					
					item.setIntent(sendMail);
					
					item = menu.add(0, TcaiBrowserActivity.CONTEXT_MENU_COPY, 0, R.string.ContextMenuCopyEmailUrl);					
					item.setIntent(createIntent(Constants.ACTION_BROWSER_CONTEXT_MENU, TcaiBrowserActivity.CONTEXT_MENU_COPY, resultType, result.getExtra()));		
					
					item = menu.add(0, TcaiBrowserActivity.CONTEXT_MENU_SHARE, 0, R.string.ContextMenuShareEmailUrl);					
					item.setIntent(createIntent(Constants.ACTION_BROWSER_CONTEXT_MENU, TcaiBrowserActivity.CONTEXT_MENU_SHARE, resultType, result.getExtra()));
