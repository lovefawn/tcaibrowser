...
public class TabView extends LinearLayout {
	...
	public void setImage(Picture picture) {
		Bitmap bm = Bitmap.createBitmap(mImageWidth, mImageHeight,
	...
	public void setFavicon(Bitmap icon) {
		BitmapDrawable bd;
		if (icon != null) {
			bd = new BitmapDrawable(Bitmap.createScaledBitmap(icon,
					mFaviconSize, mFaviconSize, false));
		} else {
			bd = null;
		}
	...
	private void updateTitle() {
		if (mTitle != null) {
			if (mSelected) {
				mTitleView.setText(Html.fromHtml(String.format("<b>%s</b>",
						mTitle)));
			} else {
