...
public class AddonsFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		TextView getAddonsTextView = (TextView) v
				.findViewById(R.id.AddonsGetAddons);
		getAddonsTextView.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View arg0) {
				try {
					Intent i = new Intent(Intent.ACTION_VIEW, Uri
							.parse("market://search?q=Tint Addon"));
					startActivity(i);
				} catch (ActivityNotFoundException e) {
					ApplicationUtils.showMessageDialog(getActivity(),
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View v, int position,
				...
				activity.startPreferencePanel(AddonDetailsFragment.class
						.getName(), args, 0, mAddons.get(position).getName(),
						AddonsFragment.this, 0);
			}
		});
