...
public abstract class BaseSpinnerPreference extends DialogPreference {
	...
	protected void onBindDialogView(View view) {
		...
		mSpinner = (Spinner) mContainer
				.findViewById(R.id.SpinnerPreferenceSpinner);
		mEditText = (EditText) mContainer
				.findViewById(R.id.SpinnerPreferenceEdit);

		ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(
				getContext(), getTitleArray(),
