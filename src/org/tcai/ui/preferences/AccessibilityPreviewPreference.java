...
public class AccessibilityPreviewPreference extends Preference implements
	...
	private void init() {
		...
		Object[] visualNames = getContext().getResources().getStringArray(
	...
	protected View onCreateView(ViewGroup parent) {
		...
		TextView title = (TextView) root
				.findViewById(R.id.AccessibilityPreviewTitle);
		title.setText(getTitle());

		TextView summary = (TextView) root
				.findViewById(R.id.AccessibilityPreviewSummary);
		...
		WebView wv = (WebView) root
				.findViewById(R.id.AccessibilityPreviewWebView);
