...
public class SearchEnginePreference extends DialogPreference implements
		ISearchUrlTaskListener {
	...
	protected void onBindDialogView(View view) {
		...
		mCustomEngineText = (TextView) view
				.findViewById(R.id.SearchUrlManualEdit);
		mCustomEngineEditText = (EditText) view
				.findViewById(R.id.SearchUrlEditText);
		...
		mProgressText = (TextView) view
				.findViewById(R.id.SearchUrlProgressText);
		...
		mList.setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				if (mAdapter != null) {
					mCustomEngineEditText
							.removeTextChangedListener(mTextWatcher);

					SearchUrlItem item = (SearchUrlItem) mAdapter.getChild(
		...
		mTextWatcher = new TextWatcher() {
			...
			public void onTextChanged(CharSequence s, int start, int before,
					int count) {
				mCurrentEngine.setText(getContext().getString(
						R.string.SearchUrlCustom));
			}
	...
	protected void onDialogClosed(boolean positiveResult) {
		...
		if (positiveResult) {
			Editor editor = PreferenceManager.getDefaultSharedPreferences(
					getContext()).edit();
			editor.putString(getKey(), mCustomEngineEditText.getText()
					.toString());
			editor.putString(getKey() + "_NAME", mCurrentEngine.getText()
					.toString());
			editor.commit();
		}
	}
	...
	private void showKeyboard() {
		InputMethodManager mgr = (InputMethodManager) getContext()
				.getSystemService(Context.INPUT_METHOD_SERVICE);
		mgr.showSoftInput(mCustomEngineEditText,
	...
	private String getCurrentSearchEngineName() {
		String name = PreferenceManager.getDefaultSharedPreferences(
				...
				Constants.PREFERENCE_SEARCH_URL + "_NAME", "");
