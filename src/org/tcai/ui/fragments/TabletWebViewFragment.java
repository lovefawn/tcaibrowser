...
public class TabletWebViewFragment extends PhoneWebViewFragment {
	...
	public void init(UIManager uiManager, Tab tab, boolean privateBrowsing,
			String urlToLoad) {
		mTab = tab;
	...
	private String stripTitle(String title) {
		int length = mUIManager.getMainActivity().getResources()
				.getInteger(R.integer.tab_title_length);
