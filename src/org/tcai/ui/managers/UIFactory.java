...
public class UIFactory {
	...
	public static UIManager createUIManager(TcaiBrowserActivity activity) {
		checkInit(activity);
	...
	private static void init(Context context) {
		String uiTypePref = PreferenceManager.getDefaultSharedPreferences(
				context).getString(Constants.PREFERENCE_UI_TYPE, "AUTO");
