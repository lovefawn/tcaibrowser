...
import org.tcai.ui.fragments.TabletStartPageFragment;
import org.tcai.ui.fragments.TabletWebViewFragment;
import org.tcai.ui.tabs.WebViewFragmentTabListener;
import org.tcai.ui.views.TabletUrlBar;
import org.tcai.ui.views.TabletUrlBar.OnTabletUrlBarEventListener;
...
public class TabletUIManager extends BaseUIManager {
	...
	public TabletUIManager(TcaiBrowserActivity activity) {
		super(activity);
	...
	protected void setFullScreenFromPreferences() {
		...
		if (mExitFullScreen != null) {
			mExitFullScreen
					.setVisibility(fullScreen ? View.VISIBLE : View.GONE);
		}
	}
