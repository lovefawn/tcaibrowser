...
import org.tcai.ui.fragments.PhoneStartPageFragment;
...
import org.tcai.ui.views.PanelLayout;
import org.tcai.ui.views.PanelLayout.PanelEventsListener;
import org.tcai.ui.views.PhoneUrlBar;
import org.tcai.ui.views.PhoneUrlBar.OnPhoneUrlBarEventListener;
import org.tcai.ui.views.TabView;
import org.tcai.ui.views.TabsScroller.OnRemoveListener;
import org.tcai.utils.*;
...
public class PhoneUIManager extends BasePhoneUIManager {
	...
	public PhoneUIManager(TcaiBrowserActivity activity) {
		super(activity);
	...
	protected void setupUI() {
		...
		ImageView openTabView = (ImageView) mActivity
				.findViewById(R.id.BtnAddTab);
		openTabView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mPreferences.getBoolean(
						Constants.PREFERENCE_CLOSE_PANEL_ON_NEW_TAB, true)) {
					mPanel.hidePanel();
				} else {
					...
					mPanel.postDelayed(new Runnable() {
						...
						@Override
						public void run() {
							mPanel.getTabsScroller().snapToSelected(
									mCurrentTabIndex, true);
						}
					}, 50);
				}
			}
		...
		ImageView openBookmarksView = (ImageView) mActivity
		...
		mFaviconView = (BadgedImageView) mActivity
				.findViewById(R.id.FaviconView);
	...
	public void onPageStarted(WebView view, String url, Bitmap favicon) {
		...
		PhoneWebViewFragment parent = (PhoneWebViewFragment) webview
				.getParentFragment();
	...
	public void onClientPageFinished(final CustomWebView view, String url) {
		...
		PhoneWebViewFragment parent = (PhoneWebViewFragment) view
				.getParentFragment();
			...
			if (mUrlBar.isUrlBarVisible()) {
				...
				if ((currentWebView != null) && (currentWebView.canGoBack())) {
					...
					if (System.currentTimeMillis() - mLastToastTime > 3000) {
						Toast toast = Toast.makeText(mActivity, R.string.ExitConfirmation,
								Toast.LENGTH_SHORT);
						toast.show();
	...
	public void onActivityResult(int requestCode, int resultCode, Intent intent) {
		if ((requestCode == TcaiBrowserActivity.ACTIVITY_BOOKMARKS)
	...
	private class TabAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView,
			...
			if (fragment.isStartPageShown()) {
				...
				tabview.setImage(webView.isLoading() ? null : webView
						.capturePicture());
			}
