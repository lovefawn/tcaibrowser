...
public class HistoryAdapter extends BaseExpandableListAdapter {
	...
	public HistoryAdapter(Context context,
			OnCheckedChangeListener bookmarksChangeListener, int faviconSize) {
		mContext = context;
	...
	public void changeCursor(Cursor cursor) {
		...
		if (mCursor != null) {
			mIdIndex = mCursor
					.getColumnIndexOrThrow(BookmarksProvider.Columns._ID);
			mDateIndex = mCursor
					.getColumnIndexOrThrow(BookmarksProvider.Columns.VISITED_DATE);
	...
	public Object getChild(int groupPosition, int childPosition) {
		...
		return new BookmarkHistoryItem(
				...
				mCursor.getInt(mCursor
						.getColumnIndex(BookmarksProvider.Columns.BOOKMARK)) >= 1 ? true
						: false,
				mCursor.getInt(mCursor
						.getColumnIndex(BookmarksProvider.Columns.IS_FOLDER)) >= 1 ? true
						: false,
				mCursor.getLong(mCursor
						.getColumnIndex(BookmarksProvider.Columns.PARENT_FOLDER_ID)),
				mCursor.getBlob(mCursor
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		BookmarkHistoryItem item = (BookmarkHistoryItem) getChild(
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if ((convertView == null) || (!(convertView instanceof TextView))) {
			...
			item = (TextView) factory.inflate(R.layout.expandable_list_header,
					null);
		} else {
