...
public class UrlSuggestionCursorAdapter extends SimpleCursorAdapter {
	...
	public UrlSuggestionCursorAdapter(Context context, int layout, Cursor c,
			String[] from, int[] to, QueryBuilderListener listener) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		int resultType = getCursor().getInt(
				getCursor().getColumnIndex(BookmarksProvider.Columns.BOOKMARK));
		...
		final String url = getCursor().getString(
				getCursor().getColumnIndex(BookmarksProvider.Columns.URL));

		ImageView queryBuilderView = (ImageView) superView
				.findViewById(R.id.AutoCompleteQueryBuilder);
