...
public class BookmarksProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "org.tcai.providers.bookmarksprovider";

	private static final String BOOKMARKS_TABLE = "bookmarks";

	public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.tcai.bookmarks";
	public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.tcai.bookmarks";

	public static final Uri BOOKMARKS_URI = Uri.parse("content://" + AUTHORITY
			+ "/" + BOOKMARKS_TABLE);
	...
	private static final String BOOKMARKS_TABLE_CREATE = "CREATE TABLE "
			+ BOOKMARKS_TABLE + " (" + Columns._ID
			+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + Columns.TITLE
			+ " TEXT, " + Columns.URL + " TEXT, " + Columns.VISITS
			+ " INTEGER, " + Columns.CREATION_DATE + " LONG, "
			+ Columns.VISITED_DATE + " LONG, " + Columns.BOOKMARK
			+ " INTEGER, " + Columns.IS_FOLDER
			+ " INTEGER NOT NULL DEFAULT 0, " + Columns.PARENT_FOLDER_ID
			+ " INTEGER NOT NULL DEFAULT -1, " + Columns.FAVICON
			+ " BLOB DEFAULT NULL, " + Columns.THUMBNAIL
			+ " BLOB DEFAULT NULL);";
	...
	public int bulkInsert(Uri uri, ContentValues[] values) {
		...
		case BOOKMARKS:
			...
			try {
				...
				SQLiteStatement insert = mDb.compileStatement("INSERT INTO "
						+ BOOKMARKS_TABLE + "(" + Columns.TITLE + ", "
						+ Columns.URL + ", " + Columns.VISITS + ", "
						+ Columns.CREATION_DATE + ", " + Columns.VISITED_DATE
						+ ", " + Columns.BOOKMARK + ", " + Columns.IS_FOLDER
				...
				for (ContentValues value : values) {
					...
					if (!TextUtils.isEmpty(title)) {
						...
						String creationDate = value
								.getAsString(Columns.CREATION_DATE);
						String visitedDate = value
								.getAsString(Columns.VISITED_DATE);
						String bookmark = value.getAsString(Columns.BOOKMARK);
						String isFolder = value.getAsString(Columns.IS_FOLDER);
						String parentFolderId = value
								.getAsString(Columns.PARENT_FOLDER_ID);
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			switch (oldVersion) {
			case 1:
				db.execSQL("ALTER TABLE " + BOOKMARKS_TABLE + " ADD "
