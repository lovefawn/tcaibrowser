...
public class Constants {
	...
	public static final String URL_ABOUT_RSSSTART = "about:rssstart";
	...
	public static final String PREFERENCE_TOOLBARS_IS_AUTOHIDE = "PREFERENCE_TOOLBARS_IS_AUTOHIDE";
	...
	public static final String PREFERENCE_NEWPHONE_LAYOUT_TYPE = "PREFERENCE_NEWPHONE_LAYOUT_TYPE";
	public static final String PREFERENCE_NEWPHONE_LAYOUT_TOP = "LAYOUT_TOP";
	public static final String PREFERENCE_NEWPHONE_LAYOUT_BOTTOM = "LAYOUT_BOTTOM";
	
	public static final String PREFERENCE_HOME_BUTTON_SET = "PREFERENCE_HOME_BUTTON_SET";
