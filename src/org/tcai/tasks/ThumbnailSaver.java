...
public class ThumbnailSaver extends AsyncTask<Void, Void, Void> {
	...
	public ThumbnailSaver(ContentResolver contentResolver, String url,
			String originalUrl, Picture picture, int[] dimensions) {
	...
	protected Void doInBackground(Void... params) {
		if (mPicture != null) {
			Bitmap bm = Bitmap.createBitmap(mCaptureWidth, mCaptureHeight,
			...
			BookmarksWrapper.updateThumbnail(mContentResolver, mUrl,
					mOriginalUrl, bm);
		}
